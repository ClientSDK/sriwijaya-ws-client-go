...
Search Flight Method (WsSearchFlight) is a service method to search flight schedule information from Sriwijaya Web Service (SOAP) v.111 [[1](https://wsp.sriwijayaair.co.id:11443/wsdl.eticketv111/index.php)].

> In this example you will learn about using  Search Flight Method (WsSearchFlight) with Go. 
...
- [Sriwijaya Air Web Service (SOAP) Client (sjwsdk111) ](github.com/ClientSDK/sriwijaya-ws-client-go/sjwsdk111)
...
- Sriwijaya Web Service Access (IP Whitelist) ( [Production](https://wsp.sriwijayaair.co.id:11443/wsdl.eticketv111/index.php), [Development](https://wsx.sriwijayaair.co.id:11443/wsdl.eticketv111/index.php) )
